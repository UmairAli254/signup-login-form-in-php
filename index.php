...
<body>
	...
	<?php include "onsubmit.php" 
	//I have added this file here instead of running the action attribute just because of the validations for email and password!
	?>
              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="number" id="form3Example3c" name="phone" class="form-control" placeholder="Your Phone" required/>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4cd" name="repeatPassword" class="form-control" placeholder="Repeat your password" required/>
